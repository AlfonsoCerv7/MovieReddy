...
movieButton.addEventListener("click", function () {
  ...
  fetch(url + APIKey + "&query=" + movieInput)
    ...
    .then(function (response) {
      ...
      imgEl.setAttribute(
        "src",
        `https://image.tmdb.org/t/p/w500${response.results[0].backdrop_path}`
      ); //get response data from console log
      ...
      overviewEl.setAttribute(
        "src",
        `https://image.tmdb.org/t/p/w500${response.results[0].overview}`
      ); //get response data from console log
